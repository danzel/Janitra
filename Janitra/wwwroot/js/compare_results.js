...
$(window).load(function() {
    ...
    $('#diff-ui-bright').click(function() {
        $('.diff-button').removeClass('is-primary');
        $('#diff-ui-bright').addClass('is-primary');
    ...
    $('#diff-ui-diff').click(function() {
        $('.diff-button').removeClass('is-primary');
        $('#diff-ui-diff').addClass('is-primary');
    ...
    $('#diff-ui-left').click(function() {
        $('.diff-button').removeClass('is-primary');
        $('#diff-ui-left').addClass('is-primary');
    ...
    $('#diff-ui-right').click(function() {
        $('.diff-button').removeClass('is-primary');
        $('#diff-ui-right').addClass('is-primary');
